...
Тези данни автоматично се попълват в таблица със съотвените колони според данните.
...
That data is automatically filled in a table with the rows appropriate for the data.
